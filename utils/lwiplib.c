...
//*****************************************************************************
#if !NO_SYS
static uint32_t g_pui32Stack[128];
#endif
...
//*****************************************************************************
#if !NO_SYS
static signed int8_t g_pi8QueueMem[sizeof(void *) + portQUEUE_OVERHEAD_BYTES];
#endif
...
lwIPPrivateInit(void *pvArg)
{
    ...
    xTaskCreate(lwIPInterruptTask, (signed portCHAR *)"eth_int",
                sizeof(g_pui32Stack) / sizeof(int), 0, tskIDLE_PRIORITY + 1,
                0);
#endif
#endif
